...
\defn{Equality}{
  Two things are equal iff one can be replaced with another at any place in the context. Denoted by $ A = B $.
  If that does not hold they are called unequal. Denoted by $ A \neq B $.
}{
...
\defn{Order}{
  ...
  There need not be order in all unequal pairs of things. For example there is no inherent order b/w a rabbit and a horse when listing out all animals. But there is an order when we consider the heights of students in a class.
}{Equality}
