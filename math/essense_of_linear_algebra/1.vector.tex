...
But seriously many problems in the (real) world apparently can be represented and solved by using list of numbers as a fundamental tool.
Okay! So lets begin here then. For us a \textbf{vector is just a list of numbers}. (Want to use the word sequence instead of list, but it might mean something else later on)
...
Well first to summarize on co-ordinate system terminology
\begin{enumerate}
