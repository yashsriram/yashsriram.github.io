...
\begin{definition}
  ...
  \textbf{A point is characterized by its properties
  \begin{enumerate}
    \item It can be enclosed by arbitrarily small 
  \end{enumerate}
  }

  \defsignificance{We use this as a building block to define useful concepts}
\end{definition}

\section{i got some blank space}

\pagebreak
\section{what the hell is a co-ordinate system?}

\begin{definition}
  \label{def:co_ordinate_system}

  \textbf{Co-ordinate system is a method to represent the concept of space with real numbers.
...
\section{co-ordinate systems and vectors}
